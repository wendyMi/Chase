...
$update_processs= "UPDATE chase_user SET user_process = ".(int)$user_process." WHERE user_id = "."'".$present_id."'";
mysqli_query($con,$update_processs);

$update_key= "UPDATE chase_user SET user_key = ".$user_key." WHERE user_id = "."'".$present_id."'";
